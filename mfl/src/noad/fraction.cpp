...
namespace mfl
{
    namespace
    {
                                      ...
                                      const code_point right_delimiter_char_code, box&& numerator, box&& denominator)
        {
            ...
            num.annotation = formula_node_type::numerator;
            auto den = rebox(width, std::move(denominator));
            den.annotation = formula_node_type::denominator;
            ...
            auto result_box = make_hbox(make_hlist(make_delimiter(s, left_delimiter_char_code, sz), std::move(middle),
