...
namespace mfl::parser
{
    ...
    {
        return (std::find_if(explicit_spaces.begin(), explicit_spaces.end(), [&](const auto& p) { return p.first == name; })
                != explicit_spaces.end());
    }
    ...
    math_space create_explicit_space(parser_state& state)
    {
        ...
        const auto it = std::find_if(explicit_spaces.begin(), explicit_spaces.end(), [&](const auto& p) { return p.first == name; });
