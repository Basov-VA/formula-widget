...
namespace mfl::fft
{
    ...
    abstract_font_face* font_face::clone() const
    {
        // This is a simplified implementation for testing purposes
        // In a real implementation, you would need to properly manage the FT_Face resource
        throw std::runtime_error("clone() not implemented for font_face in tests");
    }
}
